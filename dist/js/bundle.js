...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var createCalculator = __webpack_require__(/*! ./parts/calculator.js */ "./js/parts/calculator.js"),
...
function createCalculator() {
  var personsInput = document.querySelectorAll('.counter-block-input')[0],
...
function createTabs() {
  ...
  info.addEventListener('click', function (event) {
    var target = event.target; //Для удобства создаю переменню для таргета
...
function formContact() {
  ...
  function sendForm(elem) {
    elem.addEventListener('submit', function (event) {
      ...
      var contactFormData = new FormData(elem); //внутри создаем функци.
      ...
      function postData(data) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          var jsonContact = JSON.stringify(obj);
      ...
      postData(contactFormData).then(function () {
        return statusMessageContact.innerHTML = messageContact.loading;
      }).then(function () {
        return statusMessageContact.innerHTML = messageContact.sucess;
      }).catch(function () {
        return statusMessageContact.innerHTML = messageContact.error;
      }).then(clearInput);
    });
  }
...
function formMore() {
  ...
  form.addEventListener('submit', function (event) {
    ...
    var request = new XMLHttpRequest(); //cсоздаем мктод для настройки нашего AJAX запроса 
    ...
    var formData = new FormData(form); //проебразовываем в JSONфайл
    //Создаем промежуточный объект

    var obj = {}; // записываем наши ключи и значение полученные от пользователя в объект
    ...
    var json = JSON.stringify(obj); //открываем(отправляем на сервер) наш запрос(те данные что ввел пользователь)
...
function createModal() {
    ...
    _createClass(Btn, [{
      ...
      value: function open() {
        ...
        if (this.name.length == undefined) {
          ...
          this.name.addEventListener('click', function () {
            ...
            _this.name.classList.add('more-splash'); //Добавляем анимацию
        ...
        var _loop = function _loop(i) {
          ...
          _this.name[i].addEventListener('click', function () {
            overlay.style.display = 'block';

            _this.name[i].classList.add('more-splash');
      ...
      value: function close() {
        ...
        this.name.addEventListener('click', function () {
          ...
          _this2.name.classList.remove('more-splash'); //Убираем анимацию
  ...
  var openModalBtnTimer = new Btn(more),
...
function createTimer() {
  var deadline = '2020-04-22'; //Указываем конечное время нашего таймера
  ...
  function setClock(id, endTime) {
    ...
    var timeInterval = setInterval(updateClock, 1000); //Записываем значения
    ...
    function updateClock() {
      ...
      var t = getTimeRemaining(endTime); //получаем объет с разницей по времени
